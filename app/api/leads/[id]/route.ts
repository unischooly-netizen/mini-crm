...
attempt1Status, attempt2Status, attempt3Status, attempt4Status, attempt5Status, attempt6Status, attempt7Status, attempt8Status, attempt9Status
  ...
  await sql.query(
    `UPDATE leads SET
      attempt1_status = ${attempt1Status}, attempt1_date = ${attempt1Date}, attempt1_time = ${attempt1Time},
      attempt2_status = ${attempt2Status}, attempt2_date = ${attempt2Date}, attempt2_time = ${attempt2Time},
      attempt3_status = ${attempt3Status}, attempt3_date = ${attempt3Date}, attempt3_time = ${attempt3Time},
      attempt4_status = ${attempt4Status}, attempt4_date = ${attempt4Date}, attempt4_time = ${attempt4Time},
      attempt5_status = ${attempt5Status}, attempt5_date = ${attempt5Date}, attempt5_time = ${attempt5Time},
      attempt6_status = ${attempt6Status}, attempt6_date = ${attempt6Date}, attempt6_time = ${attempt6Time},
      attempt7_status = ${attempt7Status}, attempt7_date = ${attempt7Date}, attempt7_time = ${attempt7Time},
      attempt8_status = ${attempt8Status}, attempt8_date = ${attempt8Date}, attempt8_time = ${attempt8Time},
      attempt9_status = ${attempt9Status}, attempt9_date = ${attempt9Date}, attempt9_time = ${attempt9Time},
      state = $10, profession = $11, purpose = $12,
      total_attempts = $13, final_outcome = $14, qualification_status = $15,
      next_followup_date = $16, next_followup_time = $17, notes = $18,
      course_start_timeline = $19, meeting_date = $20, meeting_time = $21, preferred_mode = $22,
      handover_status = $23, assigned_vh_user_id = $24, assigned_counsellor_user_id = $25,
      counsellor_update = $26, owner_user_id = $27, status = $28, updated_at = now()
    WHERE id = $29`,
    [
